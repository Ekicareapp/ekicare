...
const mockClients: Client[] = [
  {
    ...
    adresse: "123 Rue des Écuries",
    ville: "Paris",
    codePostal: "75012",
    dateInscription: "2024-06-15",
    nombreEquides: 2,
    dernierRendezVous: "2025-01-10",
    totalRendezVous: 8,
    statut: "actif",
  ...
  },
  {
    ...
    adresse: "45 Avenue des Chevaux",
    ville: "Lyon",
    codePostal: "69000",
    dateInscription: "2024-08-22",
    nombreEquides: 1,
    dernierRendezVous: "2025-01-08",
    totalRendezVous: 4,
    statut: "actif",
  ...
  },
  {
    ...
    adresse: "78 Chemin des Écuries",
    ville: "Marseille",
    codePostal: "13000",
    dateInscription: "2024-05-10",
    nombreEquides: 3,
    dernierRendezVous: "2024-12-20",
    totalRendezVous: 12,
    statut: "actif",
    notes: "Éleveuse professionnelle, nombreuses demandes"
  },
  {
    id: "4",
    nom: "Bernard",
    ...
    adresse: "12 Route de la Ferme",
    ville: "Toulouse",
    codePostal: "31000",
    dateInscription: "2024-03-05",
    nombreEquides: 1,
    dernierRendezVous: "2024-11-15",
    totalRendezVous: 2,
    statut: "inactif",
    notes: "Plus de contact depuis novembre"
  },
  {
    id: "5",
    nom: "Moreau",
    ...
    adresse: "67 Boulevard des Écuries",
    ville: "Nice",
    codePostal: "06000",
    dateInscription: "2024-09-18",
    nombreEquides: 2,
    dernierRendezVous: "2025-01-05",
    totalRendezVous: 6,
    statut: "actif",
    notes: "Client récent, très impliqué"
  }
];
